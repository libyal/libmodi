 ...
 */
int libmodi_huffman_tree_initialize(
     libmodi_huffman_tree_t **huffman_tree,
     int number_of_symbols,
     uint8_t maximum_code_size,
     libcerror_error_t **error )
{
	static char *function = "libmodi_huffman_tree_initialize";
	size_t array_size     = 0;
	...
	*huffman_tree = memory_allocate_structure(
	...
	if( memory_set(
	     *huffman_tree,
	     0,
	     sizeof( libmodi_huffman_tree_t ) ) == NULL )
	{
		libcerror_error_set(
		 error,
		 LIBCERROR_ERROR_DOMAIN_MEMORY,
 ...
 * Returns 1 if successful or -1 on error
 */
int libmodi_huffman_tree_free(
     libmodi_huffman_tree_t **huffman_tree,
     libcerror_error_t **error )
{
	static char *function = "libmodi_huffman_tree_free";
 ...
 */
int libmodi_huffman_tree_build(
     libmodi_huffman_tree_t *huffman_tree,
     ...
     libcerror_error_t **error )
{
	...
	static char *function = "libmodi_huffman_tree_build";
	size_t array_size     = 0;
	uint16_t symbol       = 0;
	uint8_t bit_index     = 0;
	uint8_t code_size     = 0;
 ...
 */
int libmodi_huffman_tree_get_symbol_from_bit_stream(
     libmodi_huffman_tree_t *huffman_tree,
     libmodi_bit_stream_t *bit_stream,
     uint16_t *symbol,
     libcerror_error_t **error )
{
	static char *function  = "libmodi_huffman_tree_get_symbol_from_bit_stream";
