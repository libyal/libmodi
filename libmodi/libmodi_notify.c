...
{
	static char *function = "libmodi_notify_set_stream";
...
int libmodi_notify_stream_open(
     ...
     libcerror_error_t **error )
{
	static char *function = "libmodi_notify_stream_open";
...
int libmodi_notify_stream_close(
     libcerror_error_t **error )
{
	static char *function = "libmodi_notify_stream_close";
