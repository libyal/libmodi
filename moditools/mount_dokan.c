...
extern mount_handle_t *modimount_mount_handle;
...
NTSTATUS __stdcall mount_dokan_ZwCreateFile(
                    const wchar_t *path,
                    DOKAN_IO_SECURITY_CONTEXT *security_context MODITOOLS_ATTRIBUTE_UNUSED,
                    ACCESS_MASK desired_access,
                    ULONG file_attributes MODITOOLS_ATTRIBUTE_UNUSED,
                    ULONG share_access MODITOOLS_ATTRIBUTE_UNUSED,
                    ULONG creation_disposition,
                    ULONG creation_options MODITOOLS_ATTRIBUTE_UNUSED,
                    DOKAN_FILE_INFO *file_info )
{
	libcerror_error_t *error = NULL;
	...
	MODITOOLS_UNREFERENCED_PARAMETER( security_context )
	MODITOOLS_UNREFERENCED_PARAMETER( file_attributes )
	MODITOOLS_UNREFERENCED_PARAMETER( share_access )
	MODITOOLS_UNREFERENCED_PARAMETER( creation_options )
