...
#if !defined( _MODITOOLS_GETOPT_H )
#define _MODITOOLS_GETOPT_H
...
typedef struct moditools_option moditools_option_t;

struct moditools_option
{
...
#define moditools_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t moditools_getopt(
                  int argument_count,
...
void moditools_getopt_wrapped_fprint(
      FILE *stream,
...
void moditools_getopt_usage_fprint(
      FILE *stream,
      const char *program,
      const char *description,
      const moditools_option_t *options,
      int number_of_options );

int moditools_getopt_get_options_string(
     const moditools_option_t *options,
     int number_of_options,
...
#endif /* !defined( _MODITOOLS_GETOPT_H ) */
