...
$LocalLibs = "libbfio libcaes libcdata libcdirectory libcerror libcfile libclocale libcnotify libcpath libcsplit libcthreads libfcache libfdata libfguid libfmos libfplist libfvalue libhmac libuna"
