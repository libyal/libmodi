 ...
 */
int pymodi_file_object_io_handle_initialize(
     pymodi_file_object_io_handle_t **file_object_io_handle,
     PyObject *file_object,
     libcerror_error_t **error )
{
	static char *function = "pymodi_file_object_io_handle_initialize";
	...
	*file_object_io_handle = (pymodi_file_object_io_handle_t *) PyMem_Malloc(
	                                                             sizeof( pymodi_file_object_io_handle_t ) );
	...
	if( memory_set(
	     *file_object_io_handle,
	     0,
	     sizeof( pymodi_file_object_io_handle_t ) ) == NULL )
	{
		libcerror_error_set(
		 error,
		 LIBCERROR_ERROR_DOMAIN_MEMORY,
 ...
 * Returns 1 if successful or -1 on error
 */
int pymodi_file_object_initialize(
     libbfio_handle_t **handle,
     PyObject *file_object,
     libcerror_error_t **error )
{
	pymodi_file_object_io_handle_t *file_object_io_handle = NULL;
	static char *function                                 = "pymodi_file_object_initialize";
	...
	if( pymodi_file_object_io_handle_initialize(
	     &file_object_io_handle,
	     file_object,
	     error ) != 1 )
	{
	...
	if( libbfio_handle_initialize(
	     ...
	     (int (*)(intptr_t **, libcerror_error_t **)) pymodi_file_object_io_handle_free,
	     (int (*)(intptr_t **, intptr_t *, libcerror_error_t **)) pymodi_file_object_io_handle_clone,
	     (int (*)(intptr_t *, int, libcerror_error_t **)) pymodi_file_object_io_handle_open,
	     (int (*)(intptr_t *, libcerror_error_t **)) pymodi_file_object_io_handle_close,
	     (ssize_t (*)(intptr_t *, uint8_t *, size_t, libcerror_error_t **)) pymodi_file_object_io_handle_read,
	     (ssize_t (*)(intptr_t *, const uint8_t *, size_t, libcerror_error_t **)) pymodi_file_object_io_handle_write,
	     (off64_t (*)(intptr_t *, off64_t, int, libcerror_error_t **)) pymodi_file_object_io_handle_seek_offset,
	     (int (*)(intptr_t *, libcerror_error_t **)) pymodi_file_object_io_handle_exists,
	     (int (*)(intptr_t *, libcerror_error_t **)) pymodi_file_object_io_handle_is_open,
	     (int (*)(intptr_t *, size64_t *, libcerror_error_t **)) pymodi_file_object_io_handle_get_size,
...
on_error:
	if( file_object_io_handle != NULL )
	{
		pymodi_file_object_io_handle_free(
		 &file_object_io_handle,
		 NULL );
	}
	return( -1 );
 ...
 */
int pymodi_file_object_io_handle_free(
     pymodi_file_object_io_handle_t **file_object_io_handle,
     libcerror_error_t **error )
{
	static char *function      = "pymodi_file_object_io_handle_free";
 ...
 * Returns 1 if succesful or -1 on error
 */
int pymodi_file_object_io_handle_clone(
     pymodi_file_object_io_handle_t **destination_file_object_io_handle,
     pymodi_file_object_io_handle_t *source_file_object_io_handle,
     libcerror_error_t **error )
{
	static char *function = "pymodi_file_object_io_handle_clone";
 ...
 * Returns 1 if successful or -1 on error
 */
int pymodi_file_object_io_handle_open(
     pymodi_file_object_io_handle_t *file_object_io_handle,
     int access_flags,
     libcerror_error_t **error )
{
	static char *function = "pymodi_file_object_io_handle_open";
 ...
 */
int pymodi_file_object_io_handle_close(
     pymodi_file_object_io_handle_t *file_object_io_handle,
     libcerror_error_t **error )
{
	static char *function = "pymodi_file_object_io_handle_close";
 ...
 */
ssize_t pymodi_file_object_read_buffer(
         PyObject *file_object,
         uint8_t *buffer,
         size_t size,
         libcerror_error_t **error )
{
	...
	static char *function      = "pymodi_file_object_read_buffer";
 ...
 * Returns the number of bytes read if successful, or -1 on error
 */
ssize_t pymodi_file_object_io_handle_read(
         pymodi_file_object_io_handle_t *file_object_io_handle,
         uint8_t *buffer,
         size_t size,
         libcerror_error_t **error )
{
	static char *function      = "pymodi_file_object_io_handle_read";
	PyGILState_STATE gil_state = 0;
	ssize_t read_count         = 0;
	...
	read_count = pymodi_file_object_read_buffer(
	              file_object_io_handle->file_object,
	              buffer,
	              size,
	              error );
 ...
 */
ssize_t pymodi_file_object_write_buffer(
         PyObject *file_object,
         ...
         libcerror_error_t **error )
{
	...
	PyObject *method_name     = NULL;
	PyObject *method_result   = NULL;
	static char *function     = "pymodi_file_object_write_buffer";
 ...
 * Returns the number of bytes written if successful, or -1 on error
 */
ssize_t pymodi_file_object_io_handle_write(
         pymodi_file_object_io_handle_t *file_object_io_handle,
         const uint8_t *buffer,
         size_t size,
         libcerror_error_t **error )
{
	static char *function      = "pymodi_file_object_io_handle_write";
	PyGILState_STATE gil_state = 0;
	...
	write_count = pymodi_file_object_write_buffer(
	               file_object_io_handle->file_object,
	               buffer,
	               size,
	               error );
 ...
 * Returns 1 if successful or -1 on error
 */
int pymodi_file_object_seek_offset(
     PyObject *file_object,
     off64_t offset,
     int whence,
     libcerror_error_t **error )
{
	...
	PyObject *method_name     = NULL;
	PyObject *method_result   = NULL;
	static char *function     = "pymodi_file_object_seek_offset";
 ...
 * Returns 1 if successful or -1 on error
 */
int pymodi_file_object_get_offset(
     PyObject *file_object,
     off64_t *offset,
     libcerror_error_t **error )
{
	PyObject *method_name   = NULL;
	PyObject *method_result = NULL;
	static char *function   = "pymodi_file_object_get_offset";
	int result              = 0;
 ...
 */
off64_t pymodi_file_object_io_handle_seek_offset(
         pymodi_file_object_io_handle_t *file_object_io_handle,
         off64_t offset,
         int whence,
         libcerror_error_t **error )
{
	static char *function      = "pymodi_file_object_io_handle_seek_offset";
	PyGILState_STATE gil_state = 0;
	...
	if( pymodi_file_object_seek_offset(
	     file_object_io_handle->file_object,
	     offset,
	     whence,
	     error ) != 1 )
	...
	if( pymodi_file_object_get_offset(
	     file_object_io_handle->file_object,
	     &offset,
	     error ) != 1 )
	{
 ...
 */
int pymodi_file_object_io_handle_exists(
     pymodi_file_object_io_handle_t *file_object_io_handle,
     libcerror_error_t **error )
{
	static char *function = "pymodi_file_object_io_handle_exists";
 ...
 */
int pymodi_file_object_io_handle_is_open(
     pymodi_file_object_io_handle_t *file_object_io_handle,
     libcerror_error_t **error )
{
	static char *function = "pymodi_file_object_io_handle_is_open";
 ...
 * Returns 1 if successful or -1 on error
 */
int pymodi_file_object_get_size(
     PyObject *file_object,
     size64_t *size,
     libcerror_error_t **error )
{
	PyObject *method_name   = NULL;
	PyObject *method_result = NULL;
	static char *function   = "pymodi_file_object_get_size";
 ...
 * Returns 1 if successful or -1 on error
 */
int pymodi_file_object_io_handle_get_size(
     pymodi_file_object_io_handle_t *file_object_io_handle,
     size64_t *size,
     libcerror_error_t **error )
{
	PyObject *method_name      = NULL;
	static char *function      = "pymodi_file_object_io_handle_get_size";
	PyGILState_STATE gil_state = 0;
	...
	if( result != 0 )
	{
		if( pymodi_file_object_get_size(
		     file_object_io_handle->file_object,
		     size,
		     error ) != 1 )
		{
	...
	else
	{
		     ...
		     error ) != 1 )
		{
			...
			pymodi_file_object_seek_offset(
			 file_object_io_handle->file_object,
			 current_offset,
			 SEEK_SET,
			 NULL );
