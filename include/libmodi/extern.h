...
#if !defined( _LIBMODI_EXTERN_H )
#define _LIBMODI_EXTERN_H

/* To export functions from the libmodi DLL define LIBMODI_DLL_EXPORT
 * To import functions from the libmodi DLL define LIBMODI_DLL_IMPORT
