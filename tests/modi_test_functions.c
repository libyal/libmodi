...
{
	static char *function     = "modi_test_get_narrow_source";
...
int modi_test_get_wide_source(
     ...
     libcerror_error_t **error )
{
	static char *function   = "modi_test_get_wide_source";
 ...
 * Returns 1 if successful or -1 on error
 */
int modi_test_open_file_io_handle(
     libbfio_handle_t **file_io_handle,
     uint8_t *data,
     size_t data_size,
     libcerror_error_t **error )
{
	static char *function = "modi_test_open_file_io_handle";
 ...
 */
int modi_test_close_file_io_handle(
     libbfio_handle_t **file_io_handle,
     libcerror_error_t **error )
{
	static char *function = "modi_test_close_file_io_handle";
	int result            = 0;
