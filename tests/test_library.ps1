...
$LibraryTests = "data_block error io_handle notify sparse_bundle_xml_plist sparse_image_header udif_block_table udif_block_table_entry udif_resource_file udif_xml_plist"
...
Function RunTest
{
	...
	$TestExecutable = "${TestToolDirectory}\modi_test_${TestName}.exe"
...
Function RunTestWithInput
{
	...
	$TestProfileDirectory = GetTestProfileDirectory "input" "libmodi"
