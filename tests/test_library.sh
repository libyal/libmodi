...
LIBRARY_TESTS="bands_data_handle bit_stream data_block deflate error huffman_tree io_handle notify sparse_bundle_xml_plist sparse_image_header system_string udif_block_table udif_block_table_entry udif_resource_file udif_xml_plist";
