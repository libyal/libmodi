...
#if !defined( _MODI_TEST_GETOPT_H )
#define _MODI_TEST_GETOPT_H
...
#define modi_test_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t modi_test_getopt(
                  int argument_count,
...
#endif /* !defined( _MODI_TEST_GETOPT_H ) */
