...
uint8_t modi_test_huffman_tree_data[ 2627 ] = {
...
/* Tests the libmodi_huffman_tree_initialize function
 * Returns 1 if successful or 0 if not
 */
int modi_test_huffman_tree_initialize(
     void )
{
	...
	huffman_tree = (libmodi_huffman_tree_t *) 0x12345678UL;
	...
	for( test_number = 0;
	     ...
	     test_number++ )
	{
		/* Test libmodi_huffman_tree_initialize with malloc failing
		 */
	...
	for( test_number = 0;
	     ...
	     test_number++ )
	{
		/* Test libmodi_huffman_tree_initialize with memset failing
		 */
...
/* Tests the libmodi_huffman_tree_free function
 * Returns 1 if successful or 0 if not
 */
int modi_test_huffman_tree_free(
     void )
{
	libcerror_error_t *error = NULL;
	int result               = 0;
...
/* Tests the libmodi_huffman_tree_build function
 * Returns 1 if successful or 0 if not
 */
int modi_test_huffman_tree_build(
     void )
{
	...
	/* Test regular cases
	 */
	result = libmodi_huffman_tree_build(
	          huffman_tree,
	          code_size_array,
	          288,
	          &error );
	...
	/* Test libmodi_huffman_tree_build with malloc failing
	 */
	...
	/* Test libmodi_huffman_tree_build with memset failing
	 */
...
/* Tests the libmodi_huffman_tree_get_symbol_from_bit_stream function
 * Returns 1 if successful or 0 if not
 */
int modi_test_huffman_tree_get_symbol_from_bit_stream(
     void )
{
	uint8_t code_size_array[ 318 ];
	...
	result = libmodi_huffman_tree_get_symbol_from_bit_stream(
	          huffman_tree,
	          bit_stream,
	          &symbol,
	          &error );
...
#endif
{
	...
	MODI_TEST_RUN(
	 "libmodi_huffman_tree_initialize",
	 modi_test_huffman_tree_initialize );

	MODI_TEST_RUN(
	 "libmodi_huffman_tree_free",
	 modi_test_huffman_tree_free );

	MODI_TEST_RUN(
	 "libmodi_huffman_tree_build",
	 modi_test_huffman_tree_build );

	MODI_TEST_RUN(
	 "libmodi_huffman_tree_get_symbol_from_bit_stream",
	 modi_test_huffman_tree_get_symbol_from_bit_stream );
