...
/* Define to make modi_test_bit_stream generate verbose output
#define MODI_TEST_BIT_STREAM_VERBOSE
 */
...
#if defined( HAVE_DEBUG_OUTPUT ) && defined( MODI_TEST_BIT_STREAM_VERBOSE )
