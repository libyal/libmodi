...
#include "../libmodi/libmodi_sparse_image_header.h"

uint8_t modi_test_sparse_image_header_data1[ 4096 ] = {
	0x73, 0x70, 0x72, 0x73, 0x00, 0x00, 0x00, 0x03, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 0x00, 0x01,
...
/* Tests the libmodi_sparse_image_header_initialize function
 * Returns 1 if successful or 0 if not
 */
int modi_test_sparse_image_header_initialize(
     void )
{
	...
	/* Test regular cases
	 */
	result = libmodi_sparse_image_header_initialize(
	          &sparse_image_header,
	          &error );
	...
	result = libmodi_sparse_image_header_free(
	          &sparse_image_header,
	          &error );
	...
	sparse_image_header = (libmodi_sparse_image_header_t *) 0x12345678UL;
	...
	for( test_number = 0;
	     ...
	     test_number++ )
	{
		/* Test libmodi_sparse_image_header_initialize with malloc failing
		 */
	...
	for( test_number = 0;
	     ...
	     test_number++ )
	{
		/* Test libmodi_sparse_image_header_initialize with memset failing
		 */
...
/* Tests the libmodi_sparse_image_header_free function
 * Returns 1 if successful or 0 if not
 */
int modi_test_sparse_image_header_free(
     void )
{
	libcerror_error_t *error = NULL;
	int result               = 0;
...
/* Tests the libmodi_sparse_image_header_read_data function
 * Returns 1 if successful or 0 if not
 */
int modi_test_sparse_image_header_read_data(
     void )
{
	libcerror_error_t *error                           = NULL;
	libmodi_sparse_image_header_t *sparse_image_header = NULL;
	...
	result = libmodi_sparse_image_header_read_data(
	          sparse_image_header,
	          modi_test_sparse_image_header_data1,
	          4096,
	          &error );
...
/* Tests the libmodi_sparse_image_header_read_file_io_handle function
 * Returns 1 if successful or 0 if not
 */
int modi_test_sparse_image_header_read_file_io_handle(
     void )
{
...
#endif
{
	...
	MODI_TEST_RUN(
	 "libmodi_sparse_image_header_initialize",
	 modi_test_sparse_image_header_initialize );

	MODI_TEST_RUN(
	 "libmodi_sparse_image_header_free",
	 modi_test_sparse_image_header_free );

	MODI_TEST_RUN(
	 "libmodi_sparse_image_header_read_data",
	 modi_test_sparse_image_header_read_data );

	MODI_TEST_RUN(
	 "libmodi_sparse_image_header_read_file_io_handle",
	 modi_test_sparse_image_header_read_file_io_handle );
